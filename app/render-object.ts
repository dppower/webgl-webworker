...
export class RenderObject {
    ...
    constructor(
        ...
        private objectId_: number,
        private meshLoader_: MeshLoader,
        private textureLoader_: TextureLoader
    ) { };

    Start() {
        this.meshLoader_.loadMesh(this.meshFile_).subscribe(mesh => {
            this.mesh_ = mesh;
    ...
    Draw(gl: WebGLRenderingContext, program: WebGLProgramService, transform: Float32Array) {
        ...
        gl.vertexAttribPointer(program.aTextureCoordinates, 3, gl.FLOAT, false, 0, 0);
